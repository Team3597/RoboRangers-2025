...
public class ToAProcessor extends Command {
  ...
  /** Creates a new ToAProcessor. */
  public ToAProcessor(ElevatorSys elevatorSys, ManipulatorPitchSys manipulatorPitchSys) {
  ...
  public boolean isFinished() {
    if (elevatorSys.isHome() && manipulatorPitchSys.isAtAProcessor()) return true; // ends command once system is set
    return false;
  }
}
