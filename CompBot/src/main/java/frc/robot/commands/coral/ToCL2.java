...
public class ToCL2 extends Command {
  ...
  public void initialize() {
    if (GLOBAL.DEBUG_MODE) System.out.println("To CL2");
    elevatorSys.toCL2(); // elevator to cl2
  }
  ...
  public boolean isFinished() {
    if (elevatorSys.isAtCL2() && manipulatorPitchSys.isAtCLow()) {
      if (GLOBAL.DEBUG_MODE) System.out.println("Stopping CL2");
